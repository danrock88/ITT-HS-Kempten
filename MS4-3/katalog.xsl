						...
						<fo:inline font-size="8pt" baseline-shift="super">1</fo:inline>
							...
							<fo:footnote-body>
								...
								<fo:block font-size="10pt" text-transform="none">
									<fo:inline font-size="8pt" baseline-shift="super">1</fo:inline>
									Hier finden Sie zum einen die Fußnoten erstellt werden können und zum anderen werden unter diesem Punkt die verfügbaren Tabellen der Allgold Datenbank angezeigt. Um Details zu den jeweiligen Datenbanken einzusehen, bitte auf deren Namen klicken.
								</fo:block>
							</fo:footnote-body>
					</fo:footnote>
				</fo:inline>
...
<xsl:for-each select="/mysqldump/database/table_data">	
	<fo:page-sequence master-reference="template">
		...
		<fo:block font-size="18px" space-before="0.5cm" space-after="0.5" text-align="center">
			<fo:inline text-decoration="underline">
